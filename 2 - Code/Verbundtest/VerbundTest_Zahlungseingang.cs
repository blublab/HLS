...
{
    [TestClass]
    public class VerbundTest_Zahlungseingang
    {
        ...
        private static IBuchhaltungServicesFuerSendung buchhaltungServiceFuerSendung = null;
        ...
        private static BankAdapterFacade bankAdapter = null;
        ...
        public static void InitializeTests(TestContext testContext)
        {
            ...
            buchhaltungServiceFuerSendung = new BuchhaltungKomponenteFacade(
                persistenceService, 
                transactionService, 
                unterbeauftragungsServicesFuerBuchhaltung, 
                bankServicesFuerBuchhaltung,
            ...
            bankAdapter = new BankAdapterFacade();
            IBuchhaltungsServicesFuerBank buchhaltungServiceFuerBank = new BuchhaltungKomponenteFacade(
                persistenceService, 
                transactionService, 
                unterbeauftragungsServicesFuerBuchhaltung, 
                bankServicesFuerBuchhaltung,
                ...
                geschaeftspartnerServices,
                pDFErzeugungsServicesFuerBuchhaltung);
            bankAdapter.SetzeBuchhaltungServiceFuerBank(buchhaltungServiceFuerBank);
